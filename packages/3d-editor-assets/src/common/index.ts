/**
 * 通用 procedural 资产入口。
 * Host: `import { panel, glowRing, alertBox, enclosure, FLOOR_PRESETS, commonProceduralResolvers } from '@mh/3d-editor-assets/common'`
...
export * as enclosure from './enclosure'
export {
  FLOOR_PRESETS,
  CEILING_PRESETS,
  WALL_PRESETS,
...
import * as enclosureNs from './enclosure'
